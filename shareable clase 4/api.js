...
mongoose.connect('mongodb+srv://gebolic1500:<password>@cluster0.riqzzjx.mongodb.net/?retryWrites=true&w=majority	')
...
app.post('/register', Animal.create)
app.post('/login', Animal.create)
